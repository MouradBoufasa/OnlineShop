...
const FilterSidebar = () => {
  ...
  const handleFilterChange = (e) => {
    ...
    console.log(new URLSearchParams(newFilters));
  };

  //UseFull methode to create filtered URL
        ...
        {categories.map((category) => (
          <div key={category} className="flex items-center mb-1">
            <input
              ...
              className="mr-2 h-4 w-4 text-blue-400 focus:ring-blue-600 border-gray-400"
            />
          ...
          {colors.map((color) => (
            <button
              ...
              className={`h-8 w-8 rounded-full border border-gray-300 cursor-pointer transition hover:scale-105 ${
                filters.color === color ? 'ring-1 ring-gray-400' : ''
              }`}
